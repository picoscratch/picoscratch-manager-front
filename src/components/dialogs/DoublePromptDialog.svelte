<script lang="ts">
	...
	let resolve: (value: [string, string] | null) => void;
	...
	export function prompt(
		...
		{ placeholder1: _placeholder1, value1: _value1, submit: _submit, cancel: _cancel, type1: _type1, placeholder2: _placeholder2, value2: _value2, type2: _type2 }:
		{
			...
			value2?: string,
			type2?: "text" | "password"
		} = {placeholder1: "", value1: "", submit: m.ok(), cancel: m.cancel(), type1: "text", placeholder2: "", value2: "", type2: "text"}): Promise<[string, string] | null> {
